//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
//% This program is for Experiment No-4, Power System Lab-II of M.Tech. (EE)
//% This specifically solves the question related to plotting of swing curves.
...
//%%%%%%%%%%%%%%%%%%%% PROBLEM STATEMENT %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
//The problem statement can be found in Modern Power System Analysis 
